...
<c:url value="/employeestatus/delete/" var="deleteUrl" />
<c:url value="/employeestatus" var="listUrl" />
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<title>Employee Status List</title>
</head>
<body>
	<div >
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-bold text-primary">Employee Status
					List</h6>
			</div>
